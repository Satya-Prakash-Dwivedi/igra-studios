...
function IntroForm({ onRemove, instanceId, service }: any) {
    ...
    const styleOptions = [
        "Minimalist", "Bold", "Cinematic", "Modern", "Corporate", "Retro"
    ];

    function handleStyleSelect(selectedStyle: string) {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800 border border-red-500/30 rounded-2xl shadow-2xl overflow-hidden mb-8 backdrop-blur-sm">
            {/* Header */}
            <div className="relative px-8 py-6 bg-gradient-to-r to-transparent border-b border-red-400/20">
            ...
            <div className="px-8 py-8 space-y-8">
                ...
                <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                        <SquarePlay className="w-4 h-4 text-red-400" />
                ...
                <div className="flex items-center space-x-3">
                    <input
                        type="checkbox"
                        checked={animation}
                        id={`animation-${instanceId}`}
                        className="accent-red-500 h-5 w-5"
                        onChange={() => setAnimation(!animation)}
                    />
                    <label htmlFor={`animation-${instanceId}`} className="text-gray-300 font-semibold">
                        Add Animation Effects <span className="text-red-400">(optional, may increase credits)</span>
                    </label>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <input
                            ...
                            placeholder="https://example.com/sample-intro"
                        />
